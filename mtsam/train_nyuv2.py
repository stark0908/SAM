...
def train_mtsam_on_nyuv2(data_dir, batch_size=4, num_epochs=100, lr=1e-4, seed=42, gpu=1):
    ...
    train_loader = DataLoader(train_set, batch_size=batch_size, shuffle=True,  num_workers=8, pin_memory=True, persitent_workers=True)
    val_loader   = DataLoader(val_set,   batch_size=batch_size, shuffle=False, num_workers=8, pin_memory=True, persitent_workers=True)
